        ...
        "opciones": [
            {
                ...
                "ejemplo": "https://agenda-1-zomu.onrender.com/api/v1/turnos/disponibilidad?tecnico_id=8cd6183e-9069-4f0a-9654-4aae20ca21ef&fecha=2026-03-27"
            },
            {
                "id": 2,
                "accion": "ver_sugerencias",
                "descripcion": "Ver próximas fechas disponibles automáticamente",
                "ejemplo": "https://agenda-1-zomu.onrender.com/api/v1/turnos/sugerencias?tecnico_id=8cd6183e-9069-4f0a-9654-4aae20ca21ef"
            },
            {
                "id": 3,
                "accion": "crear_turno",
...
def obtener_turnos(
    ...
    query = (
        ...
        .where(TecnicoModel.activo == True)
    )
    if fecha:
